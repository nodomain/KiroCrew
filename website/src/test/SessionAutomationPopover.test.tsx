...
describe('SessionAutomationPopover', () => {
  ...
  it('keeps a provider-changing draft when the stop WebSocket frame wins the response race', async () => {
    const stopped = {
    ...
    expect(screen.getByRole('textbox', { name: 'Pull request URL' }))
      .toHaveValue('https://gitlab.com/acme/widgets/-/merge_requests/8')
    expect(screen.getByRole('spinbutton', { name: 'Probe cadence in seconds' }))
      .toHaveValue(600)
