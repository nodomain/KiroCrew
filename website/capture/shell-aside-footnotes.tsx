/**
 * Verification entry for the shared ShellAside footnote width cap: renders the
 * aside with each consumer flow's own footnote copy so a change to the shell's
 * footnote layout is checked against every screen that ships it, not just the
 * KAS gate. `?key=<i18n key>&lang=<locale>` selects the copy.
 */
...
createRoot(document.getElementById('root')!).render(
  <div className="flex h-screen bg-bg">
    ...
    <div className="flex m-auto overflow-hidden rounded-2xl" style={{ width: 1150, height: 760 }}>
      <ShellAside
        copy={{
          ariaLabel: 'aside',
